...
+ máxima da manha (para decidir roupa) e grave config/clima-amanha.json.
"""
...
def coletar(lat, lon):
    url = (f"https://api.open-meteo.com/v1/forecast?latitude={lat}&longitude={lon}"
           "&horário=temperatura_2m,temperatura_aparente,probabilidade_de_precipitação,"
           "precipitação, velocidade_do_vento_10m, rajadas_de_vento_10m, direção_do_vento_10m"
...
def resumir(dados, alvo):
    ...
    # sensação na largada (4h-5h) vs final (7h-8h) para tendência
